 ...
 * 
 */
public class ProdStatsReportNonLeapYear
{
	...
	public void setUp() throws Exception
	{
		...
		Date beforeDate = new Date(2013, 2, 27, 12, 0, 0);
		Date onDate = new Date(2013, 2, 28, 12, 0, 0);
		Date afterDate = new Date(2013, 3, 1, 12, 0, 0);
	...
	public final void transitionInMiddleTest()
	{
		...
		List<ProductStats> prodStatList =
				inventory.getProductStats(reportDate, 20);
	...
	{
		Date reportDate = new Date(2013, 12, 11, 0, 0, 0);

		List<ProductStats> prodStatList =
				inventory.getProductStats(reportDate, 11);
	...
	{
		Date reportDate = new Date(2013, 2, 28, 23, 59, 59);
