 ...
 * 
 */
public class ProdStatsReportLeapYear
{
	...
	public void setUp() throws Exception
	{
		...
		Date beforeDate = new Date(2012, 2, 28, 12, 0, 0);
		Date onDate = new Date(2012, 2, 29, 12, 0, 0);
		Date afterDate = new Date(2012, 3, 1, 12, 0, 0);
	...
	public final void transitionInMiddleTest()
	{
		...
		List<ProductStats> prodStatList =
				inventory.getProductStats(reportDate, 40);
	...
	public final void transitionAtBeginningTest()
	{
		...
		List<ProductStats> prodStatList =
				inventory.getProductStats(reportDate, 23);
	...
	{
		Date reportDate = new Date(2012, 2, 29, 23, 59, 59);
