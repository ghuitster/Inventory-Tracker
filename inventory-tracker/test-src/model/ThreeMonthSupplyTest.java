...
public class ThreeMonthSupplyTest
{
	...
	{
		ThreeMonthSupply threeMonthSupply = new ThreeMonthSupply(5, UnitType.STONE);
	...
	public void equalsTest()
	{
		...
		assertFalse(threeMonthSupply.equals(new String("This is going to return false")));
		ThreeMonthSupply threeMonthSupply2 = new ThreeMonthSupply(5, UnitType.CHEVROLET);
