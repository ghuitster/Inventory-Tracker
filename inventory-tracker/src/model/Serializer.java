...
public class Serializer implements IPersistence
{
	 ...
	 * @param storeName The filename of the store (based on the current working directory)
	 ...
	 * @param storeName The filename of the data store to load data from (based on the current working directory)
	 * @pre inventory is not null. storeName refers to a valid data store.
	 * @post inventory's original contents have been cleared and replaced with the data from the specified file
	 */
	@Override
	...
	/**
	 * Determines whether the passed store name is a valid filename and exists as a file in the current working directory
